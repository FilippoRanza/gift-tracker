    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="small text-secondary">{{ __('list_settings.gift-info') }}</p>
            <div class="input-group">
                <div class="form-inline">
                    <form method="POST"  action="{{ route('list:recipient') }}">
                        @csrf
                        <input type="hidden" value="{{ $list->id }}" name="list">    
                        <input type="text" id="set-recipient" required="required" class="form-control" placeholder="{{ __('list_settings.recipient_name') }}" value="{{ $recipient }}" name="recipient">
